...
export default function HomePage() {
  return (
    <>
      ...
      <div>
        <div className='block w-full max-width m-auto bg-white -translate-y-[140px]'>
          <div className='p-[110px] text-center'>
            <h1 className='w-[134px] m-auto text-xl font-semibold text-[#828282] kanit'>Latest Insights</h1>
