    ...
    <>
      <div className='w-full h-full relative'>
        <div className='relative h-full'>
          <div className='block w-[500px] h-[500px] border-[65px] border-solid border-[#645E5E] rounded-full absolute top-[68%] left-1/2 -translate-x-1/2 -translate-y-1/2 m-auto'>
